...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0 uppercase">BIENVENUE SUR LE TABLEAU DE BOARD</h4>
    </div>
        ...
        <div class="row flex-grow-1">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="card-title mb-0">Nombre de producteurs</h6>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="javascript:;"><i data-feather="edit-2"
                                            class="icon-sm me-2"></i> <span class="">Editer</span></a>
                                    <a class="dropdown-item d-flex align-items-center"
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="card-title mb-0">Nombre de produits</h6>
                            <div class="dropdown mb-2">
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="card-title mb-0">Evolution des transactions</h6>
                            <div class="dropdown mb-2">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                    <h6 class="card-title mb-0">Nombre de produits enregistrés</h6>
                    <div class="dropdown mb-2">
                ...
                <p class="text-muted">Suivre le nombre de produits enregistrés sur la blockchain chaque mois pour mesurer la croissance de l'adoption de la solution et l'activité globale de la chaîne d'approvisionnement.</p>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr>
                                <th class="pt-0">#</th>
                                <th class="pt-0">Identifiant unique du Produit (ID)</th>
                                <th class="pt-0">Hash de la transaction</th>
                                <th class="pt-0">Date et Heure</th>
                                <th class="pt-0">Etat du produits</th>
                                <th class="pt-0">Qunatité (en Tonne )</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>1234567890</td>
                                <td>0xabcdef1234567890abcdef1234567890abcdef</td>
                                <td>26/04/2022</td>
                                <td><span class="badge bg-info">Recolte</span></td>
                                <td>4</td>
                            </tr>
                            <tr>
                                <td>2</td>
                            ...
                            <tr>
                                ...
                                <td>0xabcdef1234567890abcdef1234567890abcdef</td>
                                <td>31/11/2022</td>
                                <td><span class="badge bg-info">Transport</span>
                                </td>
                                <td>143</td>
                            </tr>
                            <tr>
                                ...
                                <td>0x1234567890abcdef1234567890abcdef12345678</td>
                                <td>31/12/2022</td>
                                <td><span class="badge bg-info">Récolte</span></td>
                                <td>34</td>
                            </tr>
                            <tr>
                                <td>6</td>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom">1234567890</td>
                                <td class="border-bottom">0x1234567890abcdef1234567890abcdef12345678</td>
                                <td class="border-bottom">10/11/2022</td>
                                <td class="border-bottom"><span class="badge bg-info">Transport</span>
                                </td>
