...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h3 class="page-title">Les types d'evenements</h3>
    </div>
</div>
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <div class="head">
                    <h5 class="mb-2">Tous les evenements</h5>
                    <p>Liste de tous les evenements ajoutés</p>
                </div>
                <br>
                    ...
                    <table id="dataTableExample" class="table classes">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('culture.destroy' , $type->id )}}" method="delete">
                                        @csrf
                                        @method("DELETE")
                                      <a
                                            href=""
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <br>
                <form class="forms-sample" method="POST" action="{{ route('type_event.store') }}">
                   @csrf
