...
<body>
      ...
      <div class="sb-main-header">
               ...
               <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-8">
                     <div class="sb-top-left-section">
                        <div>
                           <a href="/mailto:madisch@example.com" class="text-white"><span><i class="fas fa-envelope"></i></span>&nbsp;
                              &nbsp;adw_2024@gmail.</a>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="sb-mid-right-section">
                        <ul>
                           <li>
                              ...
                              <a href="contact-us.html">Abidjan Cocody Deux-Plateaux, rue K4<br>
                              (GPS : 5.357177, -4.001287)</a>
                           </li>
                           <li>
                              <a href="contact-us.html"><i class="fas fa-phone"></i></a>
                              <a href="contact-us.html">Centre d'appel<br>
                                 +225 0701010203
                              </a>
                           </li>
                           <li class="border-none pe-0">
                              <a href="contact-us.html"><i class="fas fa-map-marker-alt"></i></a>
                              <a href="contact-us.html">Lun - Vend: 8:00 - 20:00<br>
                                 Sam - Dim: 9:00 - 16:00</a>
                           </li>
                        </ul>
                     </div>
                  </div>
         ...
         <div id="sidebar">
            <div class="sidebar_logo">
               <a href="javascript:;"><img src='http://lorempixel.com/g/150/150/abstract' alt=''/></a>
            </div>
            <div id="toggle_close">&times;</div>
            <div id='cssmenu'>
               <ul class="float_left">
                  <li class="has-sub">
                     <a href="javascript:;">Planteur</a>
                     <ul>
                  ...
                  <li><a href="about-us.html">Fournisseur</a></li>
         ...
         <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
               <div class="sb-banner-section">
                  <h4 class="text-white">Industruit 4.0</h4>
                  <h2 class="wow fadeIn text-white" data-wow-duration="2s" data-wow-delay=".5ms"><span><b>TECH TRACE</b></span> au coeur de la traçabilité
                     des matière première en Côte d'Ivoire
                  </h2>
                  <p class="text-white">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus animi quis tempora cum debitis doloribus, minima quae, placeat mollitia, consequatur
                  </p>
                  <a href="appoinment.html" class="button-btn mt-4">Decouvrir plus
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0">
               <section class="resp-margin">
                  <div class="sb-service-section2 serve0">
                    <h4 class="text-white"><b>Producteurs</b></h4>
                    <div class="mt-4">
                        <a class="planteur mt-2" href="{{route('login')}}">Connexion</a>
                    </div>
                  </div>
               </section>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0">
               <section class="ms-4">
                  <div class="sb-service-section2 serve1">
                    <h4 class="text-white"><b>Consomateurs</b></h4>
                    <div class="mt-4">
                        <a class="planteur mt-2" href="{{route('login')}}">Connexion</a>
                    </div>
                  </div>
         ...
         <div class="row">
            <div class="col-lg-12 col-md-12">
               <div class="sb-service-section">
                  <h5 class="home1-section-heading2">Quelques statistiques</h5>
                  <p class="text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br>Non ipsum, saepe molestiae autem inventore dolorem
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="count-up">
                  ...
                  <h3 class="counter-count">498426</h3>
                  <p class="mb-3">Agriculteurs qualifiés</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
               <div class="count-up">
                  ...
                  <p class="mb-3">Produits de qualités</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="count-up">
                  ...
                  <p class="mb-3">Tonnes exporter</p>
               </div>
            </div>
            <div class="col-lg-3  col-md-3 col-sm-6 col-xs-12">
               <div class="count-up">
   ...
   <div class="tab-one-wrapper padd-100 float-start w-100">
    <div class="section-heading">
        <h5 class="home1-section-heading2">Technologique utilisés</h5>
        <p class="text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non ipsum,<br> saepe molestiae autem inventore dolorem
        </p>
    </div>
    <div class="container">
      <div class="row">
          ...
          <div class="tab-one">
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">IOT</button>
                <span class="tab-border"></span>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="planning-tab" data-bs-toggle="tab" data-bs-target="#planning" type="button" role="tab" aria-controls="planning" aria-selected="false">IA</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="research-tab" data-bs-toggle="tab" data-bs-target="#research" type="button" role="tab" aria-controls="research" aria-selected="false">BLOCKCHAIN</button>
              </li>
            </ul>
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                      <div class="tab-one-img">
                        <img src="images/tab/about.png" alt="img" height="400" width="auto">
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                      <div class="tab-one-content">
                        <h4>Internet des Objets Connectés</h4>
                        <h2 class="my-2">Capteurs</h2>
                        <div class="tab-one-pera">
                          <p>Proin eget libero vel nunc cursus mollis ac eget sapien. Aenean porttitor euismod leo sed
                            ultrices. Ut porta iaculis lorem ut placerat. Morbi non vulputate turpis. Aenean a tempor
                            nulla. Maecenas nec pharetra felis, eget varius orci. Mauris vehicula, elit nec tincidunt
                            mattis, nisi velit dignissim libero vel commodo eros lectus vel leo. Donec condimentum
                            suscipit laoreet. Proin scelerisque mattis tristique.odio vel aliquam volutpat. in euismod
                            sem lectus. ligula vehicula enenatis semper.</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="tab-pane fade" id="planning" role="tabpanel" aria-labelledby="planning-tab">
                <div class="tab-one-home">
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                      <div class="tab-one-content">
                        <h4>Inteligence Atificiel</h4>
                        <h1>Algorithmes</h1>
                        <div class="tab-one-pera">
                          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam ratione voluptas iste quos quaerat, autem nam voluptates eius! Veniam illo fugiat tenetur nam libero quae iste tempore sapiente rem molestias.</p>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                      <div class="tab-one-content">
                        ...
                        <h1>Traçabilité</h1>
                        <div class="tab-one-pera">
                          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita odio corrupti natus consequuntur. Nihil iste id dolore porro possimus cupiditate explicabo nam, soluta maxime libero cumque saepe quis molestiae error. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente consequatur, porro officiis sunt consequuntur aperiam praesentium suscipit illo voluptates numquam inventore ex ipsa. Vero facere repellendus quis iste quas eos?</p>
                        </div>
                      </div>
                    </div>
                  </div>
   ...
   <div class="footer-main-wrapper page2-footer-main float_left">
         ...
         <div class="row footerr">
               ...
               <div class="sb-footer-section">
                  ...
                  <a href="javascript:;"><img src='http://lorempixel.com/g/150/150/abstract' alt=''/></a>
                     ...
                     <div>
                        ...
                        <p class="text-white mt-3"><i class="fas fa-map-marker-alt me-2 my"></i></p>
                        </p>
                     </div>
               </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <div class="links">
                  <h4>Liens Utiles</h4>
                  <ul>
                     <li><a href="#"><i class="fas fa-angle-right"></i>A propos de nous</a></li>
            ...
            <div class="col-lg-4 col-sm-12 col-12">
               ...
               <div class="sb-footer-section links">
                  <ul>
                     <li><a href="tel:+2250701020304"><i class="fas fa-phone"></i>Telephone : +225 0701020304</a></li>
                     <li><a href="mailto:fablabsigim@gmail.com"><i class="fas fa-envelope"></i>Repondeur mail : adw_2024@gmail.com</a></li>
                     <li><a href="http://"><i class="fas fa-mail-bulk"></i>Boite postale: 28 BP 536 Abidjan 28 - Côte d'Ivoire</p></a></li>
                     <li>
      ...
      <section>
         <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-12 col-sm-12">
                  <p>© Copyright 2024 - adw_2024 UVCI | All Rights Reserved.</p>
               </div>
