        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#emails" role="button" aria-expanded="false"
                    ...
                    <span class="link-title">Cultures</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse" id="emails">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('culture.index')}}" class="nav-link">Type de produits</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('champ.index')}}" class="nav-link">Produits</a>
                        </li>
            ...
            <li class="nav-item">
                <a href="{{ route('type_event.index')}}" class="nav-link">
                    <i class="link-icon" data-feather="hash"></i>
                    <span class="link-title">Type Evenements</span>
                </a>
            </li>
